...
const Panol = () => {
  ...
  const [accesorios, setAccesorios] = useState([
    ...
    },
    {
      id: 2,
      codigo: "ACC-002",
      descripcion: "Manija de aluminio",
      color: "Negro",
      cantidad: 150,
      marca: "Schüco",
    },
          ...
          <div className="panol-list">
            {perfiles.map((item) => (
              <div key={item.id} className="panol-card">
                ...
                <p>
                  Código: {item.codigo} | Cantidad: {item.cantidad}
                </p>
                <p>
                  Largo: {item.largo} | Color: {item.color}
                </p>
              </div>
            ))}
          </div>
          ...
          <div className="panol-list">
            {accesorios.map((item) => (
              <div key={item.id} className="panol-card">
                ...
                <p>
                  Color: {item.color} | Marca: {item.marca}
                </p>
              </div>
            ))}
          </div>
        ...
        {showModal && (
          <div className="modal-background" onClick={() => setShowModal(false)}>
            ...
            >
              ...
              <input
                type="text"
                placeholder={modalType === "perfil" ? "Código" : "Marca"}
              />
              <input
                type="text"
                placeholder={modalType === "perfil" ? "Largo" : "Modelo"}
              />
