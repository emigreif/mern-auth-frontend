    ...
    <div className="planner-background">
      <div className="planner-container">
        ...
        <p className="intro-text">
          ...
          trazabilidad y control absoluto. A continuación, te mostramos todo lo que Planner puede hacer:
        </p>
        ...
        <div className="planner-section">
          ...
          <ul>
            <li>Generá órdenes de compra para perfiles, vidrios y accesorios, gestionando fechas de entrega y stocks de forma automática.</li>
            <li>Centralizá el seguimiento de proveedores y recibí alertas cuando haya faltantes o demoras.</li>
          </ul>
        </div>
        ...
        <div className="planner-section">
          ...
          <ul>
            <li>Definí fechas clave (corte, armado, vidriado) y asigná recursos humanos según el volumen de trabajo.</li>
            <li>Obtené un tablero de producción con indicadores tipo semáforo, evitando cuellos de botella y ajustando tiempos a la realidad de tu taller.</li>
          </ul>
        </div>
        ...
        <div className="planner-section">
          ...
          <ul>
            <li>Coordiná el despacho de materiales y herramientas a obra, con remitos y calendario de instaladores.</li>
            <li>Llevá un control detallado de la colocación final y asegurate de que cada pieza cumpla con los estándares de calidad.</li>
          </ul>
        </div>
        ...
        <div className="planner-section">
          ...
          <ul>
            <li>Administrá salidas y devoluciones de máquinas, asegurando que estén disponibles en el momento justo.</li>
            <li>Programá mantenimientos y prevén paradas inesperadas.</li>
          </ul>
        </div>
        ...
        <div className="planner-section">
          ...
          <ul>
            <li>Llevá el registro de pagos (facturado y no facturado), calculá saldos pendientes y aplicá índices de actualización (CAC, dólar).</li>
            <li>Obtené una visión clara de la rentabilidad y tomá decisiones financieras fundamentadas.</li>
          </ul>
        </div>
        ...
        <div className="planner-section">
          ...
          <ul>
            <li>Monitoreá todo desde un panel unificado, con notificaciones automáticas sobre retrasos, faltantes y próximos vencimientos.</li>
            <li>Reaccioná rápidamente ante cualquier inconveniente y mantené a todo tu equipo alineado.</li>
          </ul>
        </div>
