...
const Compras = () => {
  ...
  const handleFileUpload = (event) => {
    ...
    reader.onload = (e) => {
      ...
      setCompras([
        ...compras,
        { id: compras.length + 1, materiales: parsedData },
      ]);
    };
  ...
  return (
    <div className="compras-background">
              ...
              <tr key={index}>
                ...
                <td>
                  <select
                    ...
                    onChange={(e) =>
                      handleCompraChange(index, "proveedor", e.target.value)
                    }
                  >
                ...
                <td>
                  <input
                    ...
                    onChange={(e) =>
                      handleCompraChange(index, "lugarEntrega", e.target.value)
                    }
                  />
                </td>
                <td>
              ...
              <table>
                ...
                <tbody>
                  {selectedCompra.materiales.length > 0 ? (
                    ...
                    <tr>
                      <td colSpan="4">No hay materiales cargados</td>
                    </tr>
                  )}
                </tbody>
              </table>
